...
from final import find_match, query_refiner, get_conversation_string, generate_alternative_questions, conversation, session_state
...
def signup():
    try:
        ...
        cursor = connection.cursor()
        cursor.execute("INSERT INTO user_login (email, name, password, phno, last_qs1) VALUES (%s, %s, %s, %s, %s)", (email, name, password, phno, 'NULL'))
        connection.commit()
...
def send_message():
    ...
    if user_message.lower() in ["hi", "hello", "hey"]:
        ...
        response = "I am fine, please let me know how I can assist you."
        refined_query = None
        alternatives = None
    else:
